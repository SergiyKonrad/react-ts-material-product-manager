// NB. Modal window with archived custom toast notification for editing products in the Products List page.
        ...
        onSubmit: useCallback(
            async (values) => {
                ...
                try {
                    ...
                    // NB. Archived custom toast notification with navigation support
                    /*
                    toast.info(
                    ...
                    */
                    ...
                    // Automatically navigate to the Product (home) page after editing
                    navigate('/')
                    onClose()
                } catch (error) {
            ...
            [fetchProducts, limit, navigate, onClose, product, updateProduct],
        ),
    })
